...
{
    public IEnumerable<LinkCard.LinkCardModel> BackendCards => new LinkCard.LinkCardModel[]
    {
    ...
    public IEnumerable<LinkCard.LinkCardModel> FrontendCards => new LinkCard.LinkCardModel[]
    {
