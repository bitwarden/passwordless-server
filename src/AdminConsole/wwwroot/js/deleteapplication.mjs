...
export default {
    template: /*html*/`
    <div class="mt-3">
        <button v-if="!showConfirmation" id="btn-delete-app" class="btn-secondary disabled:opacity-25" :disabled="disableDelete" @click="enableConfirmation">Delete Application...</button>
