...
public class SendGridEmailChannelStrategy
{
    private readonly SendGridMailProviderOptions _mailConfiguration;

    public SendGridEmailChannelStrategy(SendGridMailProviderOptions mailConfiguration)
    {
